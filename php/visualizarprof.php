...
<!-- Fim do Header -->
        ...
        if (($result_usuario) AND ($result_usuario->rowCount() != 0)) {
            ...
            echo"<br><br><br><br>";  
            echo " <div class=section-header><p>Aluno: <span>$prof_nome </span><br></p></div>";
            echo"<br><br>";
            echo "<div class=container data-aos=fade-up><b>CPF:</b> $prof_cpf <br>";
            echo "<b>E-mail:</b> $prof_email <br>";
            echo "<b>RG:</b> $prof_rg <br>";
            echo "<b>Nascimento:</b> $prof_nasc <br>";
            echo "<b>Telefone:</b> $prof_tele <br>";
            echo"<br><br>"; 
