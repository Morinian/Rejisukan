         ...
         <section id="contato" class="contato">
          <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
              <p><span>Listagem de Professor</span></p>
            </div> 
                ...
                $query_usuarios = "SELECT t.turma_id, t.turma_nome, p.prof_cpf, p.prof_nome FROM turma t INNER JOIN professor p ON t.prof_cpf = p.prof_cpf ORDER BY t.turma_id DESC LIMIT $inicio, $limite_resultado";
                    ...
                    while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <div class=col-md-6>
                          ...
                          <div class=info-item d-flex align-items-center>
                            ...
                            <div>
                              <h3>$turma_nome</h3>
                              <p>Professor Responsável: $prof_nome</p>
                            
                        
                              <a href='visualizarturma.php?turma_id=$turma_id'>Visualizar</a>&nbsp&nbsp&nbsp&nbsp
                              <a href='editarturma.php?turma_id=$turma_id'>Editar</a><br></div>
                          ...
                          $query_qnt_registros = "SELECT COUNT(turma_id) AS num_result FROM turma";
                          ...
                          echo " <div class=section-header><a href='listarturma.php?page=1'>Primeira&nbsp&nbsp&nbsp</a>";
      
                          for ($pagina_anterior = $pagina - $maximo_link; $pagina_anterior <= $pagina - 1; $pagina_anterior++) {
                              if ($pagina_anterior >= 1) {
                                  echo "<a href='listarturma.php?page=$pagina_anterior'>$pagina_anterior</a> ";
                              }
                          }
                          ...
                          for ($proxima_pagina = $pagina + 1; $proxima_pagina <= $pagina + $maximo_link; $proxima_pagina++) {
                              if ($proxima_pagina <= $qnt_pagina) {
                                  echo "<a href='listarturma.php?page=$proxima_pagina'>&nbsp$proxima_pagina</a>";
                              }
                          }
      
                          echo "<a href='listarturma.php?page=$qnt_pagina'>&nbsp&nbsp&nbspÚltima</a></div>";
                      } else {
