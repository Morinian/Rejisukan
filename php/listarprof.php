          ...
          <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
              <p><span>Listagem de Professor</span></p>
                ...
                $query_usuarios = "SELECT prof_id, prof_cpf, prof_nome, prof_email FROM professor ORDER BY prof_id DESC LIMIT $inicio, $limite_resultado";
                ...
                if (($result_usuarios) AND ($result_usuarios->rowCount() != 0)) {
                    while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <a href='visualizarprof.php?prof_id=$prof_id'>Visualizar</a>&nbsp&nbsp&nbsp&nbsp
                        <a href='editarprof.php?prof_id=$prof_id'>Editar</a><br></div>
                    ...
                    $query_qnt_registros = "SELECT COUNT(prof_id) AS num_result FROM professor";
